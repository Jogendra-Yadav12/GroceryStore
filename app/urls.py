...
urlpatterns = [
    ...
    path('Fruits_and_Vegetables/', views.Fruits_and_Vegetables, name='Fruits_and_Vegetables'),
    path('Colddrink_and_Jucies/',views.Colddrink_and_Jucies,name='Colddrink_and_Jucies'),
    path('Bakery_and_Cookies/', views.Bakery_and_Cookies, name='Bakery_and_Cookies'),
    path('Snacks_and_Munchies/', views.Snacks_and_Munchies, name='Snacks_and_Munchies'),
    ...
    path('passwordchangedone/',auth_views.PasswordChangeDoneView.as_view(template_name='app/passwordchangedone.html'),name='passwordchagedone'),
